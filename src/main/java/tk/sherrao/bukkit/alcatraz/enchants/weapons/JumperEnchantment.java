...
public class JumperEnchantment extends SherEnchantment {

	protected PotionEffect effect1, effect2, effect3;
	
	public JumperEnchantment( AlcatrazCore pl ) {
		super( pl, "Jumper", 206, 3, 
				Material.WOOD_SWORD, Material.STONE_SWORD, Material.IRON_SWORD, Material.GOLD_SWORD, Material.DIAMOND_SWORD );
		
		this.effect1 = new PotionEffect( PotionEffectType.JUMP, Integer.MAX_VALUE, 0, true, false );
		this.effect2 = new PotionEffect( PotionEffectType.JUMP, Integer.MAX_VALUE, 1, true, false );
		this.effect3 = new PotionEffect( PotionEffectType.JUMP, Integer.MAX_VALUE, 2, true, false );
